...
urlpatterns = patterns('apps.init.views', #prefijos de la vista que queremos jalar archivo donde estamos jalando las vistas

			url(r'^init/$' ,    'init_view' ,  name = 'vista_init') ,  
